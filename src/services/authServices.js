...
export const register = async ({ nombre, correo, password }) => {
	const credential = await authRepository.signUp(correo, password).catch((error) => {
	...
	try {
		// Se crea el doc de usuarios/ desde el cliente porque el proyecto no tiene Cloud Functions todavía;
		// migrar a un trigger onUserCreate cuando exista backend serverless, para que el rol/XP inicial
		// no dependan de un valor que el cliente puede manipular.
